...
#     model.aux_logits=False
    ...
    train_dataset_transformed = TinyImageNetDataset(
        ...
        transform=transforms.Compose([
            ...
            transforms.RandomChoice([transforms.ColorJitter(brightness=0.1),
    ...
    val_dataset = TinyImageNetDataset(
        './TinyImageNet', './TinyImageNet/val.txt', transform=transforms.Compose([transforms.ToTensor(),
                                                                                  transforms.Normalize([0.4802, 0.4481, 0.3975], [0.2302, 0.2265, 0.2262])]))
    test_dataset = TinyImageNetDataset(
        './TinyImageNet', './TinyImageNet/test.txt', transform=transforms.Compose([transforms.ToTensor(),
                                                                                   transforms.Normalize([0.4802, 0.4481, 0.3975], [0.2302, 0.2265, 0.2262])]))
